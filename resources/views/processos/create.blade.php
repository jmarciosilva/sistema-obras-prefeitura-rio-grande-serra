...
@section('subtitle', 'Cadastro de processo administrativo')

@section('content')

    <div x-data="processoForm({
        cep: {{ \Illuminate\Support\Js::from(old('cep', '')) }},
        endereco: {{ \Illuminate\Support\Js::from(old('endereco', '')) }},
        numero: {{ \Illuminate\Support\Js::from(old('numero', '')) }},
        complemento: {{ \Illuminate\Support\Js::from(old('complemento', '')) }},
        bairro: {{ \Illuminate\Support\Js::from(old('bairro', '')) }},
        cidade: {{ \Illuminate\Support\Js::from(old('cidade', '')) }},
        uf: {{ \Illuminate\Support\Js::from(old('uf', '')) }},
    })">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-2 text-sm text-slate-600">
                ...
                <span>›</span>
                <span class="text-slate-900 font-medium">Novo Processo</span>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-slate-200">
                    ...
                    <div class="px-8 py-6 border-b border-slate-200">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h2 class="text-xl font-semibold text-slate-900">Dados do Processo</h2>
                                <p class="text-sm text-slate-600 mt-1">
                                    Preencha as informações para cadastrar um novo processo administrativo
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div x-show="modalAjuda" x-cloak class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
            ...
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4">
                    <h3 class="text-lg font-semibold">📘 Ajuda — Cadastro de Processo</h3>
                    <p class="text-sm opacity-90">Como preencher o formulário</p>
                </div>

                <div class="p-6 space-y-4 text-sm text-slate-700">
                    <p><strong>Nº do Processo:</strong> Identificador oficial, ex: <em>1831/2019-5</em>.</p>
                    <p><strong>Tipo:</strong> Serviço solicitado (alvará, certidão, ofício etc.).</p>
                    <p><strong>Fase Inicial:</strong> Normalmente "Protocolado", para um processo recém-aberto.</p>
                    <p><strong>Motivo da Pendência:</strong> Preencha apenas se o processo já entrar parado por algum
                        motivo (ex.: documentação incompleta).</p>

                    <div class="bg-slate-50 p-4 rounded text-xs">
                        💡 Depois de salvar, use a tela de detalhes do processo para registrar novos trâmites e mudar
                        de fase.
                    </div>
                </div>
        ...
        <div x-show="modalResponsavel" x-cloak
            ...
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden">
                ...
                <form method="POST" action="{{ route('admin.responsaveis-tecnicos.store') }}">
                    ...
                    <input type="hidden" name="_redirect_back" value="{{ route('processos.create') }}">
