...
<div x-data="{ abaAlerta: '{{ $contratosVencidos->count() > 0 ? "contratos_vencidos" : ($contratosVencendo->count() > 0 ? "contratos_vencendo" : ($conveniosVencidos->count() > 0 ? "convenios_vencidos" : ($conveniosVencendo->count() > 0 ? "convenios_vencendo" : "sem_medicao"))) }}' }">
