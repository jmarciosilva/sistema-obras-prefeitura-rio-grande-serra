...
<div class="flex min-h-screen">
        ...
        <nav class="flex-1 px-3 py-6 space-y-1 text-sm overflow-y-auto">
            ...
            <div>
                <button @click="openAdmin = !openAdmin"
                    ...
                    <span x-show="sidebarOpen" x-text="openAdmin ? '▾' : '▸'" class="text-xs text-slate-400"></span>
                </button>

                <div x-show="openAdmin && sidebarOpen"
    ...
    <div class="flex-1 flex flex-col min-w-0">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button class="inline-flex items-center gap-1 px-3 py-1.5
        ...
        <footer class="text-center text-xs text-slate-400 py-4 border-t border-slate-200">
            Prefeitura Municipal de Rio Grande da Serra &mdash; Sistema de Acompanhamento de Obras &copy; {{ date('Y') }}
        </footer>
